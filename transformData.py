...
df = pd.read_csv('wblivereports.csv',skiprows=None)
...
for index, row in df.iterrows():
    ...
    print("The total_rating on {} at {} is {}".format( row["date"],  row["time"], df.at[index, 'total_rating']))
...
df.to_csv('transformed_wblivereports.csv')
